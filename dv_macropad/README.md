...
## Hotkeys (importante)
Los hotkeys (Ctrl+A/C/V/etc.) se envían a la ventana **activa**.
Esta app intenta devolver el foco a tu última ventana externa (Chrome/Word/Notepad) antes de enviar el atajo.
